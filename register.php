    ...
    <main class="flex flex-col items-center justify-center flex-grow">
        <div class="login-box text-center">
            ...
            <form method="post" action="singup.php" class="space-y-4">
                ...
                <div>
                    <input type="re_password" id="re_password" name="re_password" placeholder="Confirm your password" class="w-full p-2 rounded bg-transparent border-b-2 border-white text-white placeholder-white focus:outline-none">
                </div>
